...
class IConfig {
  public:
    ...
    virtual bool get_brain_serialization_enabled() const = 0;
    ...
    virtual unsigned get_max_reproducers_per_tick() const = 0;
    virtual unsigned get_max_repro_backlog() const = 0;
    virtual unsigned get_forced_repro_priority_per_tick() const = 0;
